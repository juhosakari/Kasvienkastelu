...
"""
Käynnistää autowater.py jos ei vielä päällä,
sammuttaa sen jos ei ole yhdelläkään käyttäjällä päällä
"""
...
def index(user):
	"""
	hakee viimeisimmän objektin päivämäärän perusteella
	"""
...
def settings():
	...
	#testaa tuleeko yhteys raspberrystä, jos tulee asetuksiin pääsee
